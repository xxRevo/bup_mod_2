...
NDefines.NIntel.ARMY_INTEL_COMBAT_BONUS_MAX_BONUS = 0.05	-- max combat bonus that will apply when intel is high enough
...
NDefines.NIntel.DYNAMIC_INTEL_SOURCE_EVENT_MULT_DECAY = 1
NDefines.NIntel.DYNAMIC_INTEL_SOURCE_EVENT_MAXIMUMS = { 100, 100, 100, 100 }
NDefines.NIntel.DYNAMIC_INTEL_SOURCE_EVENT_ABSOLUTE_MAXIMUMS = { 100, 100, 100, 100 }
...
NDefines.NMilitary.RETREAT_SPEED_FACTOR	= 0.5
...
NDefines.NMilitary.LAND_COMBAT_STR_DAMAGE_MODIFIER = 0.0125        -- global damage modifier... but some equipment is returned at end of battles see : EQUIPMENT_COMBAT_LOSS_FACTOR
