...
NDefines.NIntel.STATIC_INTEL_SOURCE_RADAR_MAXIMUMS = { 5.0, 5.0, 10.0, 10.0 }
NDefines.NIntel.STATIC_INTEL_SOURCE_INTEL_NETWORK_MAXIMUMS = { 20.0, 20.0, 20.0, 20.0}
NDefines.NIntel.STATIC_INTEL_SOURCE_BROKEN_CYPHER_MAXIMUMS = { 50.0, 50.0, 50.0, 50.0 }
NDefines.NIntel.INTEL_NETWORK_MAX_CIVILIAN_INTEL = 20.0
NDefines.NIntel.INTEL_NETWORK_MAX_ARMY_INTEL = 20.0
NDefines.NIntel.INTEL_NETWORK_MAX_NAVY_INTEL = 20.0
NDefines.NIntel.INTEL_NETWORK_MAX_AIRFORCE_INTEL = 20.0
NDefines.NIntel.CAPTURED_OPERATIVE_MAX_FACTOR = 30.0
...
NDefines.NIntel.CIVILIAN_PRODUCTION_RANGE_INTEL_MAX = 0.5
NDefines.NIntel.CIVILIAN_FUEL_RANGE_INTEL_MIN = 0.25
NDefines.NIntel.CIVILIAN_FUEL_RANGE_INTEL_MAX = 0.5
NDefines.NIntel.CIVILIAN_PRODUCTION_RANGE_INTEL_MAX = 0.5
...
NDefines.NIntel.CIVILIAN_MIN_INTEL_TO_SHOW_INDUSTRY_GRAPH = 0.25
...
NDefines.NIntel.INTEL_TO_SHOW_TECH_COUNT = { 0.25, 0.25, 0.25, 0.25 }
NDefines.NIntel.INTEL_TO_SHOW_PREVIOUSLY_RESEARCHED = { 0.5, 0.5, 0.5, 0.5 }
...
NDefines.NIntel.ARMY_ARMY_COUNT_RANGE_INTEL_MIN = 0.25
NDefines.NIntel.ARMY_ARMY_COUNT_RANGE_INTEL_MAX = 0.5
...
NDefines.NIntel.ARMY_STOCKPILE_COUNT_INTEL_MIN = 0.25
NDefines.NIntel.ARMY_STOCKPILE_COUNT_INTEL_MAX = 0.75
NDefines.NIntel.ARMY_DEPLOYED_MANPOWER_COUNT_RANGE_INTEL_MIN = 0.25
NDefines.NIntel.ARMY_DEPLOYED_MANPOWER_COUNT_RANGE_INTEL_MAX = 0.5
NDefines.NIntel.ARMY_MIN_INTEL_TO_SHOW_EQUIPMENT_RATIO = 0.5
...
NDefines.NIntel.ARMY_AVG_ARMOR_INTEL_MIN = 0.0
NDefines.NIntel.ARMY_AVG_ARMOR_INTEL_MAX = 0.5
NDefines.NIntel.ARMY_MAX_ARMOR_INTEL_MIN = 0.0
NDefines.NIntel.ARMY_MAX_ARMOR_INTEL_MAX = 0.5
NDefines.NIntel.ARMY_AVG_PIERCING_INTEL_MIN = 0.0
NDefines.NIntel.ARMY_AVG_PIERCING_INTEL_MAX = 0.5
NDefines.NIntel.ARMY_MAX_PIERCING_INTEL_MIN = 0.0
NDefines.NIntel.ARMY_MAX_PIERCING_INTEL_MAX = 0.5

NDefines.NIntel.NAVY_SHIP_COUNT_INTEL_MIN = 0.25
NDefines.NIntel.NAVY_SHIP_COUNT_INTEL_MAX = 0.75
NDefines.NIntel.NAVY_MIN_INTEL_TO_SHOW_SHIP_CLASSES = 0.5
...
NDefines.NIntel.NAVY_FLEET_COUNT_INTEL_MAX = 0.5
NDefines.NIntel.NAVY_TASKFORCE_COUNT_INTEL_MIN = 0.25
NDefines.NIntel.NAVY_TASKFORCE_COUNT_INTEL_MAX = 0.5
...
NDefines.NAir.ANTI_AIR_MAXIMUM_DAMAGE_REDUCTION_FACTOR = 0.65	-- Vanilla 0,75
NDefines.NAir.ANTI_AIR_ATTACK_TO_DAMAGE_REDUCTION_FACTOR = 1.05
